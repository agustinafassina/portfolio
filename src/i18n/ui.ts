...
const en = {
  ...
  'travels.searchLabel': 'Search places',
  'travels.searchPlaceholder': 'Country or city…',
  'travels.noResults': 'No places match that search.',
...
const es: Record<UIKey, string> = {
  ...
  'travels.searchLabel': 'Buscar lugares',
  'travels.searchPlaceholder': 'País o ciudad…',
  'travels.noResults': 'Ningún lugar coincide con esa búsqueda.',
...
const it: Record<UIKey, string> = {
  ...
  'travels.searchLabel': 'Cerca luoghi',
  'travels.searchPlaceholder': 'Paese o città…',
  'travels.noResults': 'Nessun luogo corrisponde a questa ricerca.',
