...
Dos ejes que los equipos suelen mezclar:
...
Ambos tipos de lanzamiento usan la **misma imagen Docker desde ECR**. La diferencia no es
el formato del contenedor; es quién parchea los hosts y cómo pagás la capacidad ociosa.
...
- Sección “evitar” para desajustes comunes—p. ej. pagar 24/7 por un job que debería ser scheduled

## Por qué existe

“¿Usamos Fargate?” es la pregunta equivocada al principio. “¿Es batch, event-driven o
always-on—y quién debería administrar los hosts?” lleva más rápido a la respuesta. Esta
carpeta es esa cheat sheet, con enlaces a los diagramas de infraestructura completa en otras
partes del repo.
