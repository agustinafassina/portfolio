...
1. **Deactivate the key** — not delete yet; you want the trail.
...
3. **Assume compromise** on anything the principal touched — S3 buckets, Lambda env vars,
   Secrets Manager paths. Rotate what was readable, not what looks suspicious.
...
<Callout variant="success" title="The habit">
  ...
  excess permission is a incident waiting for a paste command.
</Callout>
